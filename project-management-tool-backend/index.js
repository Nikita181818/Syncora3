...
const PASSWORD = 'nikita';
const DB_NAME = 'ProjectManagementDB';
const DB_URI = `mongodb+srv://${USER_NAME}:${PASSWORD}@atlascluster.xvand.mongodb.net/${DB_NAME}?retryWrites=true&w=majority&appName=AtlasCluster`;
